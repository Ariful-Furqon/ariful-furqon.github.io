...
const translations = {
  ...
  ja: {
    ...
    role_jaist: '博士課程在学中,',
    h_about: '自己紹介',
    about_text: '私はジェンベル大学計算機科学部情報学科の常勤講師(公務員)で、職位は助教です。研究分野は知識グラフの構築と応用、深層学習、自然言語処理で、主に植物の病害虫診断や農業収量予測に応用しています。現在、北陸先端科学技術大学院大学(JAIST)で博士課程に在学中です。',
    h_research: '研究分野',
    h_education: '学歴',
    lbl_ongoing: '在学中',
    lbl_now: '現在',
    h_positions: '職歴',
    pos_1: '助教、常勤講師(公務員)、情報学科、ジェンベル大学',
    pos_2: '講師、常勤講師(公務員候補)、情報学科、ジェンベル大学',
    h_publications: '論文業績',
